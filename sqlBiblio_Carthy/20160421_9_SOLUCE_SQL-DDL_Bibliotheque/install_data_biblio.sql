...
insert into empruntencours values (seq_exemplaire.currval,seq_utilisateur.currval,to_date('20-10-2009' ,'DD-MM-YYYY' ));
insert into empruntarchive values (seq_archive.nextval,to_date('10-05-2002' ,'DD-MM-YYYY' ),to_date('18-05-2002' ,'DD-MM-YYYY' ),seq_exemplaire.currval,seq_utilisateur.currval);
...
insert into empruntarchive values (seq_archive.nextval,to_date('10-03-2008' ,'DD-MM-YYYY' ),to_date('02-03-2008' ,'DD-MM-YYYY' ),seq_exemplaire.currval,seq_utilisateur.currval);
...
insert into empruntencours values (seq_exemplaire.currval,seq_utilisateur.currval,to_date('22-10-2009' ,'DD-MM-YYYY' ));
...
insert into empruntarchive values (seq_archive.nextval,to_date('03-08-2002' ,'DD-MM-YYYY' ),to_date('23-07-2002' ,'DD-MM-YYYY' ),seq_exemplaire.currval,seq_utilisateur.currval);
...
insert into empruntarchive values (seq_archive.nextval,to_date('03-11-2007' ,'DD-MM-YYYY' ),to_date('25-10-2007' ,'DD-MM-YYYY' ),seq_exemplaire.currval,1);
...
insert into empruntencours values (seq_exemplaire.currval,seq_utilisateur.currval,to_date('25-10-2009' ,'DD-MM-YYYY' ));
...
insert into exemplaire values (seq_exemplaire.nextval,to_date('21-03-2001' ,'DD-MM-YYYY' ),'DISPONIBLE',3200066559);
insert into empruntencours values (seq_exemplaire.currval,seq_utilisateur.currval,to_date('22-10-2009' ,'DD-MM-YYYY' ));
commit;
